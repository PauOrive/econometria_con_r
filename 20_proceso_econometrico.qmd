...
El segundo ingrediente imprescindible en todo estudio cuantitativo son los datos. 
Esta es la materia prima de nuestro estudio, por lo que, a mayor calidad, más potencial tendrá el estudio.

Para obtenerlos, primero debemos identificar nuestra **población objetivo**. 
...
Las unidades pueden ser personas, empresas, países... 
Lo importante es establecer claramente cuál es la unidad y delimitar el ámbito al que se restringe la población a investigar, es decir, los criterios que permiten diferencias si una entidad forma parte o no de la población objetivo.

Fíjate que la población objetivo depende de la pregunta de investigación, y que un estudio con diversas preguntas de investigación puede implicar distintas definiciones de población. 
Tomemos como ejemplo las preguntas que enumero en la @sec-todo-empieza-con-una-pregunta. A pesar que todas ellas se enmarcan en el [estudio](https://www.airef.es/es/estudios/incapacidad-temporal/) de la AIReF sobre la incapacidad temporal (IT) en España, la población objetivo cambía:  

hay veces que contaremos con toda la 
